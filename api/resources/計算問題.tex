...
\begin{enumerate}
    ...
    \item $-2$
    \item $8\div \left(-\bunsuu{2}{3}\right)^2$ を計算しなさい。%% H25後期, 0105
    \item $18$
    ...
    \item 比例式 $2:5=(x-2):(x+7)$ をみたす $x$ の値を求めなさい。%% H25前期, 0125
    \item $x=8$
    ...
    \item $4a-3b$
    \item 方程式 $0.2(x-2)=x+1.2$ を解きなさい。%% H26前期, 0125
    \item $x = -2$
    ...
    \item $3x+8y$
    \item 方程式 $\bunsuu{3x-1}{2}=\bunsuu{5x+2}{3}$ を解きなさい。%% H27後期, 0125
    \item $x=-7$
    ...
    \item 方程式 $x+3.5=0.5(3x-1)$ を解きなさい。%% H28前期, 0125
    \item $x=8$
    ...
    \item 方程式 $x-7=\bunsuu{4x-9}{3}$ を解きなさい。%% 2020前期, 0125
    \item $x=-12$
    ...
    \item 方程式 $x-4=3$ を解きなさい。%% 1-1, 0125
    \item $x=7$
    \item 方程式 $3x=-9$ を解きなさい。%% 1-2, 0125
    \item $x=-3$
    \item 方程式 $2x-5=7$ を解きなさい。%% 1-3, 0125
    \item $x=6$
    \item 方程式 $3x-8=5x-4$ を解きなさい。%% 1-6, 0125
    \item $x=-2$
    \item 方程式 $5-4x=9$ を解きなさい。%% 1-5, 0125
    \item $x=-1$
